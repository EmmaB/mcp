...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post things_url, params: { thing: { name: @thing.name, proprietary_id: @thing.proprietary_id, proprietary_name: @thing.proprietary_name, string: @thing.string } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { name: @thing.name, proprietary_id: @thing.proprietary_id, proprietary_name: @thing.proprietary_name, string: @thing.string } }
